    ...
    st.markdown(
        ...
        <main class="terms-page">
            <header class="terms-hero">
                ...
                <div class="mandatory-review-note"><strong>What you are agreeing to</strong><br>Your conversations, AI responses, roleplay settings, and feedback are stored for the retention period you select. Conversation storage is required while your account is active. You can delete individual conversations, change the retention period, or permanently delete your account.</div>
                ...
                <section class="terms-item"><div class="terms-number">03</div><div><h2>AI-generated responses</h2><p>Your messages and relevant conversation context are sent to the configured AI provider so its language model can generate a reply. Listener conversations use Groq and Partner conversations use Venice. AI responses can be inaccurate, incomplete, or inappropriate for your circumstances. Review suggestions carefully and do not rely on DilSe for urgent, medical, legal, financial, or safety-critical decisions.</p></div></section>
                <section class="terms-item"><div class="terms-number">04</div><div><h2>Your account</h2><p>Provide a valid email address, use a secure password, and keep your sign-in details private. You are responsible for activity through your account. Tell the service operator if you believe someone else has gained access.</p></div></section>
                <section class="terms-item"><div class="terms-number">05</div><div><h2>Conversation storage and privacy</h2><p>DilSe processes account details, text messages, optional voice notes, roleplay settings, feedback, and technical usage records. Conversations and voice notes are stored in the application database so users can reopen them.</p><ul><li>Conversation storage is required while your account is active. You can select a retention period of 7 to 365 days.</li><li>Voice notes are optional and are stored only when the user records and sends one. They follow the conversation's retention period and are deleted with the message, conversation, or account.</li><li>DilSe records the page visited, first and last visit time, and a masked network prefix for service monitoring. A full IPv4 or IPv6 address is reduced before storage, the raw address is not retained, and visitor records are deleted after 30 days.</li><li>You can permanently delete an individual conversation or your account and its associated stored data.</li><li>Conversations may contain sensitive details about relationships, sexuality, family, health, or finances. Share only what you are comfortable submitting to DilSe.</li><li>A public deployment requires production security, access controls, backups, incident procedures, and a jurisdiction-specific privacy notice.</li></ul></div></section>
                <section class="terms-item"><div class="terms-number">06</div><div><h2>Required account processing</h2><p>DilSe stores account details, conversations, settings, and technical records needed to provide the service. Conversation storage cannot be disabled while your account is active. You can change the retention period, delete individual conversations, or permanently delete your account.</p></div></section>
                ...
                <section class="terms-item"><div class="terms-number">09</div><div><h2>Your content</h2><p>You retain any rights you have in the content you submit. You give the service operator limited permission to host, process, transmit, and display that content as needed to run DilSe, protect the service, and provide the features described in these terms.</p></div></section>
                <section class="terms-item"><div class="terms-number">10</div><div><h2>Availability and changes</h2><p>The MVP may be interrupted, changed, or withdrawn. Features, usage limits, AI providers, and language models may change. No uninterrupted availability, preservation of data, or continued access to a specific model is guaranteed.</p></div></section>
                ...
                <section class="terms-item"><div class="terms-number">12</div><div><h2>Ending access and changing these terms</h2><p>You may stop using DilSe and delete your account. Access may be suspended for security risks, prohibited use, or material breach of these terms. Material changes require renewed acceptance before you continue using account features.</p></div></section>
...
def render_terms_update() -> None:
    ...
    st.markdown(
        ...
        <div class="mandatory-review-note"><strong>What you are agreeing to</strong><br>Your conversations, AI responses, roleplay settings, and feedback are stored for the retention period you select. You can delete individual conversations, change the retention period, or permanently delete your account.</div>
        """,
        unsafe_allow_html=True,
    )
